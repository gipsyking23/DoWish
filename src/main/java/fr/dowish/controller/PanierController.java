...
public class PanierController {
	...
	@GetMapping(value = "client/enregistrer")// verifié
	...
	@GetMapping(value = "client/modifier") //Todo
	...
	@DeleteMapping(value = "client/effacer")
	public void effacerUnPanier(@RequestParam Long id) {
		panierservice.effacer(id);

	}
	@GetMapping(value = "client/trouver")
