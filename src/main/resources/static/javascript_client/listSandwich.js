									...
									success : function(response) {
										...
										$
												.each(
														response,
														function(key, value) {
															trHTML += '<tr><td><div class="dropdown"><button class="sandwich dropdown-toggle" value="'
																	+ value.nom
																	+ '" type="button" id="dropdownMenu'
																	+ key
																	+ '" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">'
																	+ value.nom
																	+ '</button><ul class="dropdown-menu" aria-labelledby="dropdownMenu'
																	+ key
																	+ '"></ul</div></td><td>'
																	+ value.prix
																	+ '&nbsp&nbsp&nbsp<input type="radio" value="'
																	+ value.nom
																	+ '"></td></tr>';
														});
