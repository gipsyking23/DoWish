											...
											.each(
													...
													function(clé, valeur) {
														...
														trHTML += '<p><b>numéro de commande: </b>'
																...
																+ valeur.date
																+ '</p><p><b>boulangerie: </b>'
																+ valeur.boulangerie.nom
																+ '</p><p><b>statut: </b>'
																+ valeur.statut.nom
																+ '</p><p><b>commentaire: </b>'
																+ valeur.commentaire
																+ '</p><a class="btn btn-primary" value="'
																+ valeur.panier.numeropanier.référence
																+ '" role="button" data-toggle="collapse" href="#collapseExample'
																+ clé
																+ '"aria-expanded="false" aria-controls="collapseExample">détail</a>  <p></p><div class="collapse" id="collapseExample'
																+ clé
																+ '"><div class="well"><b>Total:</b>'
																+ valeur.panier.total
																+ 'eu <b>Date de retrait:</b>'
																+ valeur.panier.dateretrait
																+ ' <b>Heure de retrait:</b>'
																+ valeur.panier.heureretrait
																+ '<div class="wellwell"></div></div></div><hr /> '
														$('#réponse').append(
																trHTML);
										...
										$
												.ajax({
													...
													success : function(response) {
														...
														trHTML += '<p><b>date de retrait:</b>'
																+ response.dateretrait
																+ '&nbsp<b>heure de retrait:</b>'
